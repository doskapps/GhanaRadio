...
public class _SearchableSpinner extends android.support.v7.widget.AppCompatSpinner implements View.OnTouchListener,
    ...
    public _SearchableSpinner(Context context) {
        super(context);
        this._context = context;
        init();
    }

    public _SearchableSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        this._context = context;
    ...
    public _SearchableSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
