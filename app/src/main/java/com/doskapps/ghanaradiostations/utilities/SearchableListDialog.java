package com.doskapps.ghanaradiostations.utilities;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    private IgnoreAccentsArrayAdapter listAdapter;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String strPositiveButton = _strPositiveButtonText == null ? getResources().getString(R.string.select_country_cancel) : _strPositiveButtonText;
        alertDialog.setPositiveButton(strPositiveButton, _onClickListener);

        String strTitle = _strTitle == null ? getResources().getString(R.string.select_country_title) : _strTitle;
    ...
    public boolean onQueryTextChange(String s) {
        ...
        if (TextUtils.isEmpty(s)) {
            ...
            ((IgnoreAccentsArrayAdapter) _listViewItems.getAdapter()).getFilter().filter(null);
        } else {
            ((IgnoreAccentsArrayAdapter) _listViewItems.getAdapter()).getFilter().filter(s);
        }
